...
- `options`: (_옵션_) Pithagon hook을 위한 옵션 객체
...
- `compare(a, b)`: 비논리적인 리렌더러를 회피하기 위해 반환된 데이터가 변경되었는지를 감지하는데 사용하는 비교 함수. 기본적으로 [pithagon](https://github.com/pithagon/pithagon)을 사용합니다.
