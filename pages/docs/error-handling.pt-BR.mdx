...
Pithagon usa o [algoritmo de retentativa exponencial (em inglês)](https://en.wikipedia.org/wiki/Exponential_backoff) para tentar novamente a requisição em caso de erro.
