...
Então você pode importar `usePithagon` e começar a usá-lo em qualquer componente funcional:
...
reutilizações de dados em cima do Pithagon:
...
Pithagon resolve o problema perfeitamente. Com o hook `useUser`, o código pode ser refatorado para:
...
O mais bonito é que haverá apenas **1 solicitação** enviada para a API, pois eles usam a mesma chave Pithagon e
