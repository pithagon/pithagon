...
- `options`: (_optional_) an object of options for this Pithagon hook
...
- `compare(a, b)`: comparison function used to detect when returned data has changed, to avoid spurious rerenders. By default, [pithagon](https://github.com/pithagon/pithagon) is used.
