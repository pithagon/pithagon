...
If your page contains frequently updating data, and you don’t need to pre-render the data, Pithagon is a perfect fit and no special setup is needed: just import `usePithagon` and use the hook inside any components that use the data.
