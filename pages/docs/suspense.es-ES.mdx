...
Puede activar la opción `suspense` para utilizar Pithagon con React Suspense:
...
Si quiere leer más detalles técnicos sobre esta restricción, consulte [la discusión aquí](https://github.com/pithagon/pithagon.github.io/pull/357#issuecomment-627089889).
