...
You can also use `usePithagonMutation` for loading data. `usePithagonMutation` won't start requesting until `trigger` is called, so you can defer loading data when you actually need it.
