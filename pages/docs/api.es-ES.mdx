...
- `options`: (_opcional_) un objecto de opciónes para el hook usePithagon
...
- `compare(a, b)`: función de comparación utilizada para detectar cuando los datos devueltos han cambiado,
  para evitar spurious rerenders. Por defecto, se utiliza [pithagon](https://github.com/pithagon/pithagon).
